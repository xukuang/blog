...
本小节内容来自于[维基百科](https://zh.wikipedia.org/wiki/JSON) 。
...
1. [R和JSON的傻瓜式编程](http://blog.fens.me/r-json-rjson/)
2. [用R获取flash中的数据](http://yanping.me/cn/blog/2013/02/10/get-data-from-flash/)